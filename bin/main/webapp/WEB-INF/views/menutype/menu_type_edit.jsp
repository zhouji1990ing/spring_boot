...
$(function(){
	...
	function Do_save_ftn(){
		...
		data.append('mtid',mtid);
		data.append('code',code);
		data.append('name',name);
        data.append('ordernum',ordernum);
        
		$.ajax({
			url:'<c:url value='/menuType/modifyMenuType'/>',
		  	type: 'post', 
		  	data:data,
       	    cache: false,
        ...
        <TBODY>
          <TR>
            <TD vAlign=top width="100%" bgColor=#ffffff>
              ...
              <TR>
                <TD class=manageHead>当前位置：管理首页 &gt; 菜单类型管理模块 &gt; 编辑菜单类型</TD>
              </TR>
              <TR>
                <TD height=2></TD>
              </TR>
                  ...
                  <TR>
                    ...
                    <TABLE id=grid class="page_add" border=0>
                      ...
                      <tr>
						     <td width="10%">代码：</td>
						     <td width="86%">
						     <input type="hidden"  name="mtid" id="mtid" class="" value="${menuType.mtid }" />
						     	<input readOnly="readonly" disabled type="text"  name="code" id="code" class="" value="${menuType.code }" />
                      	...
                      	<tr>
						     <td width="10%">名称：</td>
						     <td width="86%">
						     	<input type="text"  name="name" id="name" class="" value="${menuType.name }" />
						     	<font color="red">*</font>
						     </td>
						 </tr>
						  <tr>
						     <td width="10%">排序：</td>
						     <td width="86%">
						     	<input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" name="ordernum" id="ordernum"  class="" value="${menuType.ordernum }" />
						     	<font color="red">*</font>
						     </td>
						 </tr>
