...
$(function(){
	...
	function Do_save_ftn(){
		...
		$.ajax({
			url:'<c:url value='/keyWord/modifyKeyWord'/>',
		  	type: 'post', 
		  	data:data,
       	    cache: false,
        ...
        <TBODY>
          <TR>
            <TD vAlign=top width="100%" bgColor=#ffffff>
              ...
              <TR>
                <TD class=manageHead>当前位置：管理首页 &gt; 类别管理模块 &gt; 编辑类别</TD>
              </TR>
              <TR>
                <TD height=2></TD>
              </TR>
                  ...
                  <TR>
                    ...
                    <TABLE id=grid class="page_add" border=0>
                      ...
                      <tr>
						     <td width="10%">代码：</td>
						     <td width="86%">
						     <input type="hidden"  name="keywordId" id="keywordId" class="" value="${keyWord.keywordId }" />
						     	<input type="text"  name="keywordName" id="keywordName" class="" value="${keyWord.keywordName }" />
