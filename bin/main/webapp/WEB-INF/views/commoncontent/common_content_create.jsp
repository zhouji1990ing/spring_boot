...
function doUploadLogo(){
   ...
   $.ajax({
	...
	function Do_save_ftn(){
		...
		data.append('key',key);
		data.append('thumbMediaId',media_id);
		...
		$.ajax({
			url:'<c:url value='/commonContent/saveCommonContent'/>',
		  	type: 'post', 
		  	data:data,
       	    cache: false,
       	  	contentType: false,    //不可缺
        ...
        <TBODY>
          <TR>
            <TD vAlign=top width="100%" bgColor=#ffffff>
              ...
              <TR>
                <TD class=manageHead>当前位置：管理首页 &gt; ${commonContent.codeName }管理模块 &gt; 添加${commonContent.codeName }</TD>
              </TR>
              <TR>
                <TD height=2></TD>
              </TR>
                  ...
                  <TR>
                    ...
                    <TABLE id=grid class="page_add" border=0>
					  ...
					  <tr>
						    <td width="10%">文件编号：</td>
						     <td width="86%">
						     	<input type="text"  name="digest" id="digest" class="input_wb" />
								<font color="red">*</font>
						     </td>
						 </tr>
                      <tr>
						 ...
						 <tr>
						    <td width="10%">信息来源：</td>
						     <td width="86%">
						     	<input type="text"  name="author" id="author" class="input_wb" />
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr>
