        ...
        <TBODY>
          <TR>
            <TD vAlign=top width="100%" bgColor=#ffffff>
              ...
              <TR>
                 <TD class=manageHead>当前位置：管理首页 &gt; 管理 &gt; 详情</TD>
              </TR>
              <TR>
                <TD height=2></TD>
              </TR>
              ...
              <TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
                <TBODY>
                  ...
                  <h1 class="title" style="text-align:center;font-size: 2.2rem;font-weight: bold;line-height: 1.5;padding:20px 0px;color: #38485a;">${sdetail.name }</h1>
                  	
                  	<div id="head_img" align="center">
