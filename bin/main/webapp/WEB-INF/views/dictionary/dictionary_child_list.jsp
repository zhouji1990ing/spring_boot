...
//删除操作（单个操作）
function doRemoveOne(code,parentcode){
	//首先判断是否有效
	if(code == ''){
		alert("该条记录无效，无法删除！");
		return false;
	...
	if(confirm("您确定要删除所选的记录吗？")){
		 $.ajax({
		  	   type: 'post', 
		  	   url:'<c:url value='/dictionary/removeDictionaryChild'/>?code='+code+'&parentcode='+parentcode,
                  ...
                  <TR>
	                  <TD height="35px">
		                  <!-- 工具栏区域，主要是快捷按钮，如添加，删除，导入，导出 -->
		                 	 ...
		                 	 <INPUT class=button id="back" type="button" value=" 添加 " onclick="javascript:window.location='<c:url value='/dictionary/createDictionaryChild?parentcode=${dictionary.parentcode }' />'" />
                    ...
                    <TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
                        ...
                        <TR style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none" height="30px">
                   		...
                   		<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none" height="30px">
                            ...
                            <TD width="20%" class="list_td_align"><a title="点击查看详细信息" href="<c:url value="/dictionary/detailDictionaryChild?code=${list.code }&parentcode=${list.parentcode }"/>">${list.code}</a></TD>
                            ...
                            <TD width="30%" class="list_td_align">
                            	<a href="<c:url value="/dictionary/editDictionaryChild?code=${list.code}&parentcode=${list.parentcode }"/>">修改</a> |
                            	<A href="javascript:void(0)" onclick="doRemoveOne('${list.code }','${list.parentcode }')">删除</A> 
                            </TD>
                         </TR>
                   		</c:forEach>
