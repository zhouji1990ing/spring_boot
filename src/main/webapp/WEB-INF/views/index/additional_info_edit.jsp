        ...
        <TBODY>
          <TR>
            <TD vAlign=top width="100%" bgColor=#ffffff>
              ...
              <TR>
                <TD class=manageHead>当前位置：管理首页 &gt; 推荐信息管理模块 &gt; 编辑推荐信息</TD>
              </TR>
              <TR>
                <TD height=2></TD>
              </TR>
              ...
              <TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
                <TBODY>
                  ...
                  <TR>
                    <TD align="center">
						<p>&nbsp;</p>                    
                    <FORM id="saveForm" name="saveForm" action="<c:url value="/additionalInfo/modifyInfo"/>" method=post>
                    <input type="hidden" name="infoId" value="${info.infoId }" />
                    <input type="hidden" name="module" value="${info.module}" />
                    <input type="hidden" name="moduleAttribute" value="${info.moduleAttribute}" />
                    <input type="hidden" name="entity" value="${info.entity}" />
                    <TABLE id=grid class="page_add" border=0>
                      <TBODY>
                      	<tr>
						     <td width="100">推荐类别名称：</td>
						     <td width="500">
						     	${info.moduleAttribute}
						     </td>
						 </tr>
                         <tr>
						     <td width="100">推荐名称：</td>
						     <td width="200"><input type="text" name="entityAttribute" id="entityAttribute" value="${info.entityAttribute}"  class="input_wb" />（如：张牧之）</td>
						 </tr>
                         <tr>
						     <td width="100">链接地址：</td>
						     <td width="200"><input type="text" name="entityUrl" id="entityUrl" value="${info.entityUrl }"  class="input_wb" />（如：http://mis.konyo.com.cn:9090/）</td>
						 </tr>
						 <tr>
						  	 <td width="82">备注：</td>
							<td><textarea name="description" id="description" rows="4" cols="40">${info.description}</textarea>
							</td>
						 </tr>
						 <tr>
