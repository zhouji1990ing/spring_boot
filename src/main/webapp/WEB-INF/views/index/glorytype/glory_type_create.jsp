...
$(function(){
	...
	function Do_save_ftn(){
		...
		$.ajax({
			url:'<c:url value='/gloryType/saveGloryType'/>',
		  	type: 'post', 
		  	data:data,
       	    cache: false,
        ...
        <TBODY>
          <TR>
            <TD vAlign=top width="100%" bgColor=#ffffff>
              ...
              <TR>
                <TD class=manageHead>当前位置：管理首页 &gt; 光荣事迹(巢籍官兵)类型管理模块 &gt; 添加光荣事迹(巢籍官兵)类型信息</TD>
              </TR>
              <TR>
                <TD height=2></TD>
              </TR>
                    ...
                    <TABLE id=grid class="page_add" border=0>
                      <TBODY>
                      	<tr>
						     ...
						     <td width="86%">
						     	<input type="text"  name="name" id="name" class="input_wb" />
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr><td></td></tr>
						 <tr>
						     <td width="10%">排序：</td>
						     <td width="86%">
						     	<input type="text"  name="isorder" id="isorder" class="input_wb" value="0" onkeyup="this.value=this.value.replace(/\D/g,'')" />
						     </td>
						 </tr>
						 <tr><td></td></tr>
						 <tr> 
