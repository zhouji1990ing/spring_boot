...
function doUploadLogo(){
	...
	function Do_save_ftn(){
		...
		$.ajax({
			url:'<c:url value='/glory/modifyGlory'/>',
		  	type: 'post', 
		  	data:data,
       	    cache: false,
       	  	contentType: false,    //不可缺
        ...
        <TBODY>
          <TR>
            <TD vAlign=top width="100%" bgColor=#ffffff>
              ...
              <TR>
                <TD class=manageHead>当前位置：管理首页 &gt; 光荣事迹(巢籍官兵)管理模块 &gt; 编辑光荣事迹(巢籍官兵)信息</TD>
              </TR>
              <TR>
                <TD height=2></TD>
              </TR>
			...
			<tr><td></td></tr>
                      	...
                      	<tr>
						     <td width="10%">标题：</td>
						     <td width="86%">
						     	<input type="text"  name="title" id="title" class="input_wb" value="${glory.title }"/>
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr><td></td></tr>
                         ...
                         <tr>
						     <td width="10%">内容：</td>
						     <td width="86%">
						     	<textarea name="content" id="content" rows="" cols="">${glory.content }</textarea>
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr>
						     <td width="10%">事迹日期：</td>
						     <td width="86%">
						     	<INPUT value="${glory.happenedtimeStr }" type="text"  id="happenedtimeStr" name="happenedtimeStr" size="20" maxLength=10  onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="" />
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr>
						     <td width="10%">排序：</td>
						     <td width="86%">
						     	<input type="text"  name="isorder" id="isorder" class="input_wb" value="${glory.isorder }" />
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr>
