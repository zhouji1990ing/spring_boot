...
$(function(){
	...
	function Do_save_ftn(){
		...
		var videoTypeId='${videoType.videoTypeId}';
		...
		data.append('videoTypeId',videoTypeId);
		data.append('name',$('#name').val());
		data.append('isorder',isorder);
        
		$.ajax({
			url:'<c:url value='/videoType/modifyVideoType'/>',
		  	type: 'post', 
		  	data:data,
       	    cache: false,
                    ...
                    <TABLE id=grid class="page_add" border=0>
                      <TBODY>
                      	<tr>
						     ...
						     <td width="86%">
						     <input type="hidden" name="videoTypeId" id="videoTypeId" value="${videoType.videoTypeId }" />
						     	<input type="text"  name="name" id="name" value="${videoType.name }" class="input_wb" />
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr><td></td></tr>
						 <tr>
						     <td width="10%">排序：</td>
						     <td width="86%">
						     	<input type="text"  name="isorder" id="isorder" class="input_wb" value="${videoType.isorder }" onkeyup="this.value=this.value.replace(/\D/g,'')" />
						     </td>
						 </tr>
						 <tr><td></td></tr>
						 <tr> 
