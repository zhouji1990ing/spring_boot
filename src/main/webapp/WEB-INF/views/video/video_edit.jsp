...
function doUpload(){
	...
	function Do_save_ftn(){
		...
		var data = new FormData();
		data.append('videoid',$('#videoid').val());
		...
		$.ajax({
			url:'<c:url value='/video/modifyVideo'/>',
		  	type: 'post', 
		  	data:data,
       	    cache: false,
       	  	contentType: false,    //不可缺
                      ...
                      <TBODY>
                      	<tr>
						     ...
						     <td width="86%">
						     	...
						     	<input type="text"  name="videoname" id="videoname" class="input_wb" value="${video.videoname }"/>
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr><td></td></tr>
						 ...
						 <tr>
                          <td width="10%">视频封面：</td>
                      		<td width="86%">
                      		<div id="head_img">
                      			<img src='<c:url value="${video.logoUrl }" />' width='200'  />
                      		</div>
                          ...
                          <td width="10%">视频视频：</td>
                      		<td width="86%">
      								...
      								poster='${video.logoUrl }' data-setup="{}">
                         ...
                         <tr>
						     <td width="10%">视频简介：</td>
						     <td width="86%">
						     	<textarea name="videocontent" id="videocontent" rows="" cols="">${video.videocontent }</textarea>
						     	<font color="red">*</font>
						     </td>
						 </tr>
						 <tr><td></td></tr>
