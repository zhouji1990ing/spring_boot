...
$(function(){
	...
	function Do_save_ftn(){
		...
		data.append('keywordName',keywordName);
        
		$.ajax({
			url:'<c:url value='/keyWord/saveKeyWord'/>',
		  	type: 'post', 
		  	data:data,
       	    cache: false,
        ...
        <TBODY>
          <TR>
            <TD vAlign=top width="100%" bgColor=#ffffff>
              ...
              <TR>
                <TD class=manageHead>当前位置：管理首页 &gt; 类别管理模块 &gt; 添加类别</TD>
              </TR>
              <TR>
                <TD height=2></TD>
              </TR>
                  ...
                  <TR>
	                  <TD height="35px">
		                  <!-- 工具栏区域，主要是快捷按钮，如添加，删除，导入，导出 -->
		                 	 ...
		                 	 <INPUT class=button id="back" type="button" value=" 返回列表 " onclick="javascript:window.location='<c:url value='/keyWord/list' />'" />
	                  </TD>
                  </TR>
                  <TR><TD><hr/></TD></TR>
                  <TR>
                    ...
                    <TABLE id=grid class="page_add" border=0>
                      ...
                      <tr>
						     <td width="10%">类别：</td>
						     <td width="86%">
						     	<input type="text"  name="keywordName" id="keywordName" class="" />
						     	<font color="red">*</font>
						     </td>
						 </tr>
